...
CHECKPOINT_TO_LOAD = PROJECT_ROOT / "checkpoints_six_layer" / "six_layer_step_10000.pt"

OUTPUT_CSV = PROJECT_ROOT / "six_layer_metrics_continued_10001_to_15000.csv"
CHECKPOINT_DIR = PROJECT_ROOT / "checkpoints_six_layer"
SAMPLES_DIR = PROJECT_ROOT / "samples_six_layer"
...
def main():
    ...
    print("=== Continue 6-layer training to 15000 (Colab) ===")
    ...
    for step in range(start_step + 1, TARGET_STEP + 1):
        ...
        if step % SAVE_EVERY == 0:
            ckpt_path = CHECKPOINT_DIR / f"six_layer_step_{step}.pt"
