...
CHECKPOINT_TO_LOAD = PROJECT_ROOT / "checkpoints_real_experiment" / "real_experiment_step_5000.pt"

OUTPUT_CSV = PROJECT_ROOT / "real_experiment_metrics_continued_5001_to_10000.csv"
...
def main():
    ...
    print("=== Continue real experiment training (Colab) ===")
    ...
    final_ckpt_path = CHECKPOINT_DIR / "real_experiment_final_step_10000.pt"
