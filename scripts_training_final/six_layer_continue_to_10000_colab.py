...
CHECKPOINT_TO_LOAD = PROJECT_ROOT / "checkpoints_six_layer" / "six_layer_step_5000.pt"

OUTPUT_CSV = PROJECT_ROOT / "six_layer_metrics_continued_5001_to_10000.csv"
...
def main():
    ...
    print("=== Continue 6-layer training to 10000 (Colab) ===")
