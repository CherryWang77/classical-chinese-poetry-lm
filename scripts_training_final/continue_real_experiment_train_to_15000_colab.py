...
CHECKPOINT_TO_LOAD = PROJECT_ROOT / "checkpoints_real_experiment" / "real_experiment_step_10000.pt"

OUTPUT_CSV = PROJECT_ROOT / "real_experiment_metrics_continued_10001_to_15000.csv"
CHECKPOINT_DIR = PROJECT_ROOT / "checkpoints_real_experiment"
SAMPLES_DIR = PROJECT_ROOT / "samples_real_experiment"
...
def main():
    ...
    print("=== Continue real experiment training to 15000 (Colab) ===")
