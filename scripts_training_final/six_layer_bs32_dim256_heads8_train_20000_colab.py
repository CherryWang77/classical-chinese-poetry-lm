...
OUTPUT_CSV = PROJECT_ROOT / "six_layer_bs32_dim256_heads8_metrics_20000.csv"
CHECKPOINT_DIR = PROJECT_ROOT / "checkpoints_six_layer_bs32_dim256_heads8_20000"
SAMPLES_DIR = PROJECT_ROOT / "samples_six_layer_bs32_dim256_heads8_20000"

# =========================
# Config: 6-layer / bs32 / dim256 / heads8
# =========================
VAL_RATIO = 0.1
CONTEXT_LENGTH = 256
BATCH_SIZE = 32
...
def main():
    ...
    print("=== 6-layer / BS32 / Dim256 / Heads8 experiment training (20000, Colab) ===")
    ...
    for step in range(1, NUM_STEPS + 1):
        ...
        if step % SAVE_EVERY == 0:
            ckpt_path = CHECKPOINT_DIR / f"six_layer_bs32_dim256_heads8_step_{step}.pt"
        ...
        if step % GENERATE_EVERY == 0:
            ...
            sample_path = SAMPLES_DIR / f"six_layer_bs32_dim256_heads8_sample_step_{step}.txt"
            save_sample_text(sample_path, sample_text)
            print("Sample saved to:", sample_path)

    final_ckpt_path = CHECKPOINT_DIR / "six_layer_bs32_dim256_heads8_final_20000.pt"
    save_checkpoint(final_ckpt_path, model, optimizer, NUM_STEPS, vocab_size)

    write_csv_log(csv_rows, OUTPUT_CSV)

    print("\n6-layer / BS32 / Dim256 / Heads8 experiment completed.")
